...
job-description-prisoner = Sit in prison. Gamble with your cellmates. Talk to the armorer. Write your memoirs.
job-description-public-affairs-liaison = Manage the external affairs of LSRD, liaise with the media, and ensure that whatever that goes wrong is remedied with a good PR spin.
job-description-security-guard = Help keep Nash Station safe, under the employment of LSRD, and under the direction of the Chief Ranger and Nash's administrative staff.
job-description-senior-officer = Hold highest authority under the Chief Ranger, manage the department, and ensure that all deputies are performing their duties.
job-description-sheriff = Manage your department and keep them efficient, quell dissent, and keep the sector safe.
job-description-stc = Expertly de-conflict the space around the station and help the LSRD issue fines for overdocked ships.
