...
nf-tips-dataset-27 = As an LSRD officer, communicate and coordinate with your fellow officers using the LSRD radio channel to avoid confusion."
nf-tips-dataset-28 = As an LSRD officer, remember that correlation does not equal causation. Someone may have just been at the wrong place at the wrong time!"
...
nf-tips-dataset-55 = When dealing with LSRD, you may get your sentence reduced through cooperation and/or deception.
...
nf-tips-dataset-106 = LSRD has access to long range radar! If you're an outlaw, watch out for Prowlers stalking in the void!
...
nf-tips-dataset-110 = There's a special app installed in your PDA, which allows you to see posted bounties. If you can fulfill one of them, you can ask the local SR or Chief Ranger for a reward!
...
nf-tips-dataset-112 = If you're using an IFF console, remember to turn your IFF on when not purposefully skulking about, or you'll risk facing LSRD on your ship!
...
nf-tips-dataset-114 = Expeditions can yield rare and useful items, and not all of them are legal. Try not to leave those lying on the floor, as LSRD might board you at some point!
...
nf-tips-dataset-120 = There are multiple ways to earn money. Why not get a job on Nash Station, join LSRD, go salvaging, do science, or do something totally illegal? Other players can teach you each one of them!
