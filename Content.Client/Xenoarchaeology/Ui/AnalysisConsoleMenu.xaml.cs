...
public sealed partial class AnalysisConsoleMenu : FancyWindow
{
    ...
    public void SetSelectedNode(Entity<XenoArtifactNodeComponent>? node)
    {
        ...
        // // Frontier: hide xenoarch effects // LoneStar: Remove
        ...
        EffectValueLabel.SetMarkup(Loc.GetString("analysis-console-info-effect-value", // LoneStar: Readd XenoArch Effects
            ("state", hasInfo),
