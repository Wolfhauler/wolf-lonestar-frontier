...
using Content.Shared.Chemistry.Reagent; // LoneStar: Localized name for chemicals
...
public sealed partial class PlantAnalyzerWindow : FancyWindow
{
    ...
    [Dependency] private readonly IPrototypeManager _prototypeManager = default!; // LoneStar: Localized name for chemicals
    ...
    public PlantAnalyzerWindow()
    {
        ...
        dependencies.InjectDependencies(this); // LoneStar: Localized name for chemicals
    ...
    public void Populate(PlantAnalyzerScannedSeedPlantInformation msg)
    {
        ...
        if (msg.SeedChem != null)
        {
            foreach (var chem in msg.SeedChem)
            {
                ...
                //chemString.Append(chem); // LoneStar: Localized name for chemicals
                chemString.Append(_prototypeManager.TryIndex<ReagentPrototype>(chem, out var reagent) // LoneStar: Localized name for chemicals
